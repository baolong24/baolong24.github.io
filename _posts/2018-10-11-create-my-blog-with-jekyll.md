...
layout: post
title:  "Jekyll 搭建静态博客"
date:   2019-1-19 18:29:42
categories: jekyll
author: 1404のxiaobao
excerpt: 一直以来都想搭建一个自己的博客，在百度上看到一些用GitHub Pages创建的教程，于是就试着做了下。
...
一直以来都想搭建一个自己的博客，在百度上看到一些用GitHub Pages创建的教程，于是就试着做了下。




## 我参照的教程来自这里 [点我打开](https://blog.csdn.net/xudailong_blog/article/details/78762262)

## 下面的教程来自于[Gaohaoyang](https://github.com/Gaohaoyang)
